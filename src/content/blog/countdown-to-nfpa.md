...
pubDate: 2026-06-16
heroImage: "/images/sparx-nfpa-hero-og.jpg"
---
...
Cassie and Bobby built a **Revit plugin** that lets the design team assign Device IDs directly to sprinklers in their BIM models. Those IDs become a starting point for where devices get installed in the field, with installers able to fine-tune positions right on the Hub when needed. The plugin exports a **.sparx file** (Sparx Project File) that feeds into the **Sparx Installation Tool**, a simple but critical app that wirelessly uploads that project file to the Hub.
...
Because when you're demoing fire safety technology at the NFPA Conference and Expo — with 8,600 attendees from 88 countries — "works on my machine" isn't quite good enough.
